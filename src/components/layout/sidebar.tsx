...
export function Sidebar() {
  ...
  return (
    <aside className="flex h-full w-56 flex-col border-r border-invisapprove-border bg-invisapprove-surface">
      {/* Logo */}
      <div className="flex h-14 items-center gap-2.5 px-4 border-b border-invisapprove-border">
        <div className="flex h-7 w-7 items-center justify-center rounded-card bg-invisapprove-primary shadow-[0_0_12px_rgba(91,79,217,0.4)]">
