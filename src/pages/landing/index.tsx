...
const STEPS = [
  ...
  },
  {
    num: "02",
    title: "Route",
    desc: "Rules evaluate context — amount, category, team — and assign or auto-approve instantly.",
  },
  {
    num: "03",
    title: "Decide",
    ...
    >
      ...
      <nav className="sticky top-0 z-50 border-b border-[#1E2A3F]/60 bg-[#0B0F1A]/90 backdrop-blur-sm">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-2.5">
            <div className="flex h-7 w-7 items-center justify-center rounded-[6px] bg-[#5B4FD9] text-[11px] font-bold text-white">
              IA
            </div>
            <span
      ...
      <footer className="border-t border-[#1E2A3F]">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-6 py-8 sm:flex-row">
          <div className="flex items-center gap-2">
            <div className="flex h-6 w-6 items-center justify-center rounded-[5px] bg-[#5B4FD9] text-[9px] font-bold text-white">
              IA
            </div>
            <span
